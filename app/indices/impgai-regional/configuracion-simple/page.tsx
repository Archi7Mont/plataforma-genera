...
export default function ConfiguracionPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    localStorage.setItem('impgai_configuracion', JSON.stringify({
      pais: formData.pais,
    ...
    router.push("/indices/impgai-regional/dimensiones-advanced");
  };
      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-xl shadow-lg p-8">
          <h1 className="text-3xl font-bold text-[#8350EB] mb-8 text-center">
            Configuración de la aplicación del IMPGAI
          </h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                onChange={handleInputChange}
                className="w-full p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-purple-200 focus:border-purple-400"
                placeholder="Ingrese el nombre de la institución auditada"
                required
              />
            </div>
