...
export default function DimensionesPage() {
  ...
  const isLastDimension = currentDimensionId === 'C'; // IMPGPP Regional has 3 dimensions: A, B, C
  ...
  const handleSaveAndNavigate = () => {
    if (isCurrentDimensionCompleted) {
      if (isLastDimension) {
        ...
        router.push('/indices/impgpp-regional/resultados');
      } else {
        ...
        <div className="bg-white shadow-sm border-b border-gray-200 px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <button
                onClick={() => router.push('/indices/impgpp-regional/configuracion')}
