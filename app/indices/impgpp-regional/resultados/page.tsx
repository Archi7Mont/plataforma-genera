...
import { dimensiones } from "../data/impgpp-regional-data";
...
export default function ResultadosPage() {
  ...
  useEffect(() => {
    ...
    if (storedConfig) {
      ...
      router.push('/indices/impgpp-regional/configuracion');
      return;
    }
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="text-gray-600 mt-2 space-y-1">
                ...
                <p>
                  Institución Auditada: <strong>{configuracion.institucionAuditada}</strong>
                </p>
                <p>
                  Política Pública: <strong>{configuracion.politicaPublicaAuditada}</strong>
                </p>
                <p>
                  Año/Período Auditado: <strong>{configuracion.anoPeriodoAuditado}</strong>
                </p>
                <p>
            ...
            <div className="flex items-center space-x-4">
              <button
                onClick={() => router.push('/indices/impgpp-regional/dimensiones')}
